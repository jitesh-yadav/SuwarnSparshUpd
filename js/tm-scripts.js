...
$('.login-btn').click(function () {
    $('#PopupController').modal("show");
    $('#loginDiv').show();
    $('#signUpDiv').hide();
    $('#loginUsername').focus();
});
//When Not registered is clicked
$('#notRegistered').click(function () {
    $('#loginDiv').hide("slow");
    $('#signUpDiv').show("slow");
    $('#signupUsername').focus();
});
//When Already registered is clicked
...
$('#SignInBtn').click(function(){
	...
	if (username.indexOf("consultant") >= 0){
		localStorage.setItem('consultantname',username);
